...
def make_scripts_executable():
    ...
    os.system('chmod u+x BugRuns/bug_id_1.sh')
    os.system('chmod u+x BugRuns/bug_id_2.sh')
    os.system('chmod u+x BugRuns/bug_id_3.sh')
    os.system('chmod u+x BugRuns/bug_id_4.sh')
...
def install_dependencies(env_name: str, requirements_file:str):
    ...
    os.system('./MLHCBugs_Requirements_Install.sh ' + env_name + ' RepoRequirements/' + requirements_file)
...
def init_breast_cancer_classifier():
    ...
    init_repo(repository_name, python_version, repository_git_address, repository_commit)
