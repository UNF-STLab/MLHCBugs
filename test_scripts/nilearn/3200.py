...
threshold = 3.0
print(stat_img)
table1 = get_clusters_table(stat_img, threshold, cluster_threshold=4)
table2 = get_clusters_table(stat_img, threshold, cluster_threshold=None)
print(table1)
print(table2)
...
#   Cluster ID     X     Y     Z  Peak Stat Cluster Size (mm3)
# 0          1  39.0 -22.0  58.0   7.941345              59832
# 1         1a  42.0 -19.0  19.0   7.941345                   
# 2         1b   6.0 -10.0  52.0   7.941345                   
# 3         1c  33.0  -7.0  -2.0   7.905312                   
# 4          2 -18.0 -52.0 -23.0   7.941345              10206
# 5         2a  -6.0 -70.0 -38.0   4.260736                   
# 6          3  60.0   8.0  28.0   3.358555                108
# 7          4 -66.0 -25.0  31.0   3.338923                189
#    Cluster ID     X     Y     Z  Peak Stat Cluster Size (mm3)
# 0           1  39.0 -22.0  58.0   7.941345              60399
# 1          1a  42.0 -19.0  19.0   7.941345                   
# 2          1b   6.0 -10.0  52.0   7.941345                   
